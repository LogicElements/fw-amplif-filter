...
/**
 * Maximal number of circuits
 */
#define CONF_MAX_CIRCUITS  2
...
#define CONF_HW_REVISION    (conf.fact.hw_revision / 1000000)
...
/**
 * This function checks the register map and prepare stream for all registers that need to be synchronized to server
 * @param data Pointer to the buffer to store the stream
 * @param length Length of the created stream
 * @return Status
 */
